...
<body >
    ...
    <h1 style="text-align: center; margin-top: 0px auto; background-color: #80ced6; padding: 15px;">Make Appointment</h1>
    ...
    @endif
      <form method="post" action="{{route('appointment')}}" style="margin-right: 400px; margin-left: 400px; margin-top: 50px;">
          @csrf
